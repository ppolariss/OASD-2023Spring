...
function transferToArtDom(artList, i) {
    ...
    artDiv.innerHTML = "<div class=\"art-img\"><img class=\"art-pic\" src=\"../pic/artPic/" + artList[i].pic + "\" alt=\"" + artList[i].art_name + "\"></div>" +
        "<div class=\"art-name\">" + artList[i].art_name + "</div><div class=\"art-author\">作者：" + artList[i].author +
        "</div><div class=\"art-price\">价格：￥" + artList[i].price + "</div>";
        // + "<div class=\"art-id\" style=\"visibility : hidden;\">" + artList[i].art_id + "</div>"

        // + "<div class=\"art-description\">详细描述：" + artList[i].description + "</div>"
